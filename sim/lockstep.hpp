...
namespace vf {
inline constexpr uint32_t kLockstepProtocolVersion = 1;
#ifdef VF_CONTENT_ID
...
inline constexpr size_t kMaxFrameBytes = 33 + kMaxFrameCommands * (4 + 26 + 256 * 4);
...
enum class AdvanceResult { Waiting, Advanced, Invalid, Desync };
class Lockstep {
public:
    ...
    // Missing frames never advance. Invalid/Desync are terminal for this immutable turn.
